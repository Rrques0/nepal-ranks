...
export const metadata = { title: "Speed Leaderboard" };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-black text-white">Speed Rankings</h1>
          <p className="text-sm text-[#A0A0A0]">Nepal&apos;s fastest reflexes</p>
        </div>
      </div>
      <CategoryFilter active="speed" />
      ...
      <div className="text-sm text-[#6B7280]"><span className="text-white font-medium">{total}</span> athletes</div>
      <Suspense fallback={<LeaderboardSkeleton />}>
        {stats.length === 0 ? (
          <EmptyState title="No speed athletes yet" description="Be the fastest in Nepal!" actionLabel="Submit Speed Stats" actionHref="/submit/speed" />
        ) : (
